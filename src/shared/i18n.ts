...
export const zhTranslations: Record<string, string> = {
  ...
  'Automatically copy selected text in the terminal to the clipboard':
    '自动将终端中选中的文本复制到剪贴板',
  'Codex Scroll Patch': 'Codex 滚屏补丁',
  'Only enable this on Windows 10 if Codex scrolling is broken.':
    '仅建议 Windows 10 上遇到滚屏问题时开启。',
  'OpenCode Scroll Patch': 'OpenCode 滚屏补丁',
  'Only enable this on Windows 10 if OpenCode scrolling is broken.':
    '仅建议 Windows 10 上遇到 OpenCode 滚屏问题时开启。',
  'Codex Transcript': 'Codex 历史记录',
  'Codex Session': 'Codex 会话',
  'Codex Session Record': 'Codex 会话记录',
  'Codex Session Viewer': 'Codex 会话查看',
  'Configure Codex session viewing behavior': '配置 Codex 会话查看行为',
  'Show Codex session viewer button and enable viewing functionality':
    '显示 Codex 会话查看按钮并启用查看功能',
  'Content Display': '会话内容显示',
  'Full Display': '完整显示',
  'Commentary and Reply Only': '仅说明和回复',
  'Choose which message types to display in the session viewer':
    '选择在会话查看器中显示哪些消息类型',
  'Initial Position': '打开时定位',
  'Scroll to Top': '定位到开头',
  'Scroll to Bottom': '定位到末尾',
  'Initial scroll position when opening the session viewer': '打开会话查看器时的初始滚动位置',
  'Auto Refresh': '自动刷新',
  'Automatically reload session content while viewer is open': '在查看器打开时自动重新加载会话内容',
  'Refresh Interval': '自动刷新频率',
  '2 seconds': '2 秒',
  '3 seconds': '3 秒',
  '5 seconds': '5 秒',
  'How often to refresh session content automatically': '自动刷新会话内容的频率',
  'Jump Buttons': '显示顶部/底部直达按钮',
  'Show scroll to top/bottom buttons in the viewer': '在查看器中显示滚动到顶部/底部的按钮',
  'Window Height': '窗口高度',
  'Adjust the height of the session viewer window': '调整会话查看器窗口的高度',
  'Window Width': '窗口宽度',
  'Adjust the width of the session viewer window': '调整会话查看器窗口的宽度',
  'Font Size': '会话文字大小',
  'Adjust the font size of session content': '调整会话内容的文字大小',
  'Scroll to top': '滚动到顶部',
  ...
  'Compact Mode': '精简模式',
  'Other settings can be adjusted in the session viewer toolbar':
    '其他设置可在会话查看器工具栏中调整',
  Session: '会话',
  Updated: '更新时间',
  'Pending match': '等待匹配',
  'Not resolved yet': '尚未解析',
  'Loading Codex transcript...': '正在加载 Codex 历史记录...',
  'Loading Codex session record...': '正在加载 Codex 会话记录...',
  'No readable Codex transcript was found yet.': '暂未找到可读取的 Codex 历史记录。',
  'No readable Codex session record was found yet.': '暂未找到可读取的 Codex 会话记录。',
  'Failed to load Codex transcript.': '加载 Codex 历史记录失败。',
  'Failed to load Codex session record.': '加载 Codex 会话记录失败。',
  'Bound Codex history does not match the current workspace.':
    '已绑定的 Codex 历史与当前工作区不匹配。',
  'Bound Codex session record does not match the current workspace.':
    '已绑定的 Codex 会话记录与当前工作区不匹配。',
  'No matching Codex session was found for this workspace.':
    '未找到与当前工作区匹配的 Codex 会话。',
  User: '用户',
  Assistant: '助手',
  Commentary: '说明',
  'Tool Output': '工具输出',
