...
export const zhTranslations: Record<string, string> = {
  ...
  'Are you sure you want to discard changes to {{path}}? This cannot be undone.': '确定要放弃 {{path}} 的更改吗？此操作不可撤销。',
  'Are you sure you want to exit the app?': '确定要退出应用吗？',
  'Are you sure you want to remove {{name}} from the workspace?': '确定要从工作区移除 {{name}} 吗？',
  ...
  'Close Tab': '关闭标签',
  'Collapse': '折叠',
  'Collapse Workspace': '折叠 Workspace',
  ...
  'Click the button in the top right to create your first worktree': '点击右上角按钮创建第一个 Worktree',
  'Confirm exit': '确认退出',
  ...
  'Generating...': '生成中...',
  'History lines in the terminal. Higher values use more memory.': '终端可向上滚动查看的历史行数，值越大内存占用越高',
  'How long to wait before notifying after the agent stops output.': 'Agent 停止输出后等待多久发送通知',
  ...
  'Stage all': '全部暂存',
  'System': '跟随系统',
  'This branch will be created and checked out in the new worktree.': '将创建此分支并在新 worktree 中检出',
  'This directory has already been removed; Git records will be cleaned up.': '该目录已被删除，将清理 git 记录。',
  'This directory contains uncommitted changes. Please check "Force delete".': '目录包含未提交的修改，请勾选「强制删除」',
